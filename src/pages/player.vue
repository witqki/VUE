   ...
   <!-- <div class="player-bg"
    ...
    <div class="mod-player">
      ...
      <div class="mod-footer">
        ...
        <a href="javascript:;" @click="playmusic()"  :class="{ 'btn_big_play': isA, 'btn_big_pause': isB}"></a>
        <a href="javascript:;" class="btn_big_next"></a>
        <div class="player_music">
          <div class="music_info">
            <a href="" class="song_info">{{songList[id].name}}</a>
            -
            <a href="" class="singer">{{songList[id].singer}}</a>
          </div>
          <div class="play_music_time">
            <p class="startT">00:00</p>
            -
            <p class="endT">{{(transformTime(songList[id].time))}}</p>
          </div>
          <!-- 音乐播放进度调-->
...
-->
    ...
    <audio  :src="this.songUrl[0]" autoplay id="myAudio"></audio>
  </div>
</template>
  ...
  export default {
    ...
    mounted() {
      ...
      //this.id = this.$store.state.index
       ...
       this.songUrl.push("http://39.96.172.186:8080/Bigbang%20-%20LOSER(Japanese%20Ver.).mp3");
 console.log('success:'+this.songList)

       //this.songUrl.push("./music/Bigbang - LOSER(Japanese Ver.).mp3");
...
<style lang="scss" scoped>
  ...
  .btn_big_only, .btn_big_play,.btn_big_pause, .btn_big_prev,
